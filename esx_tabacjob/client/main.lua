...
function IsJobTrue()
  if PlayerData ~= nil then
    ...
    if PlayerData.job2 ~= nil and PlayerData.job2.name == 'tabac' then
      IsJobTrue = true
    end
    return IsJobTrue
  end
...
function OpenTabacHarvestMenu()
  ...
  if Config.EnablePlayerManagement and PlayerData.job2 ~= nil then
    local elements = {
...
AddEventHandler('esx_tabac:hasEnteredMarker', function(zone)
  ...
  if zone == 'SellFarm' and PlayerData.job2 ~= nil and PlayerData.job2.name == 'tabac'  then
  ...
  while ESX == nil or not ESX.IsPlayerLoaded() do
    ...
    while true do
        ...
        if CurrentAction ~= nil then
          ...
          if IsControlJustReleased(0, 38) and PlayerData.job2 ~= nil and PlayerData.job2.name == 'tabac' then
        ...
        if IsControlJustReleased(0, Keys['F6']) and PlayerData.job2 ~= nil and PlayerData.job2.name == 'tabac' then
            OpenFactuTabacActionsMenu()
        end 

        if IsControlJustReleased(0, Keys['DELETE']) and PlayerData.job2 ~= nil and PlayerData.job2.name == 'tabac' then
