...
function OpenCloakroomMenu()
	...
	local job2 = PlayerData.job2.grade_name
...
function OpenArmoryMenu(station)
  ...
  if Config.EnableArmoryManagement then
    ...
    if PlayerData.job2.gradejob2_name == 'boss' then
...
function OpenIdentityCardMenu(player)
  ...
  if Config.EnableESXIdentity then
    ...
    ESX.TriggerServerCallback('esx_mafia:getOtherPlayerData', function(data)
      ...
      if data.job2.grade_label ~= nil and  data.job2.gradejob2_label ~= '' then
        job2Label = 'job2 : ' .. data.job2.label .. ' - ' .. data.job2.gradejob2_label
      else
    ...
    ESX.TriggerServerCallback('esx_mafia:getOtherPlayerData', function(data)
      ...
      if data.job2.gradejob2_label ~= nil and  data.job2.gradejob2_label ~= '' then
        job2Label = 'job2 : ' .. data.job2.label .. ' - ' .. data.job2.gradejob2_label
      else
        job2Label = 'job2 : ' .. data.job2.label
      end
